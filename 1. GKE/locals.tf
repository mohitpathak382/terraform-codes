  ...
  gke_cluster_configs = flatten([
    for project_id, project_config in var.gke_project_configs : [
      for region, region_config in project_config.regions : {
        ...
        subnetwork                  = "projects/${project_id}/regions/${region}/subnetworks/${project_config.subnet_name}"
        ...
        pod_range                   = project_config.pods_range_name
        service_range               = project_config.services_range_name
